...
const Orders = () => {
  ...
  return (
    <div style={{ background: "#fff", padding: "20px 16px", borderRadius: 14, border: "1px solid #e5e7eb" }}>
      <div
        style={{
          display: "flex",
      ...
      >
        <div>
          ...
          <p style={{ margin: "2px 0 0", fontSize: 13, color: "#6b7280" }}>
            Review customer orders, update delivery milestones & verify payments
          </p>
        </div>
        <Button
          icon={<ReloadOutlined />}
          ...
          <div style={{ marginTop: 14 }}>
            ...
            >
              ...
              {selectedOrder.deliveryAddress?.note && (
                <Descriptions.Item label="Customer Instructions">
            ...
            >
              ...
              >
                <b>Total Invoice:</b>
                <b style={{ color: "#2e7d32", fontSize: 18 }}>
